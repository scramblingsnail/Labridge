...
from labridge.parse.paper.parsers.nature_parser import NaturePaperParser, NATURE_CONTENT_NAMES
from labridge.parse.paper.parsers.base import CONTENT_TYPE_NAME
