...
DEFAULT_INSTRUMENT_WAREHOUSE_DIR = "docs/instruments"
...
class InstrumentStorage(object):
	...
	def _add_instrument_docs_to_warehouse(
		...
		r"""
		Store the instrument docs in the instrument warehouse.
	...
	def delete_instrument_doc(
		...
		r"""
		Delete specific docs from the instrument storage and warehouse.
